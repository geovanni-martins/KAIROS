...
('Jo�o Silva',  'joao@email.com',   '123456', 'STUDENT'),
...
('Fra��es',              'MATH'),
('Equa��es de 1� grau',  'MATH'),
('Equa��es de 2� grau',  'MATH'),
('Porcentagem',          'MATH'),
('Regra de Tr�s',        'MATH'),
('Geometria Plana',      'MATH'),
('Trigonometria',        'MATH'),
('Fun��es',              'MATH'),
('Sistemas de Equa��es', 'MATH'),
('N�meros Inteiros',     'MATH'),
('Potencia��o',          'MATH'),
('Radicia��o',           'MATH'),
('MMC e MDC',            'MATH');
...
-- QUEST�ES (todas NOT_VERIFIED, com difficulty por quest�o)

-- FRA��ES (topic_id = 1)
INSERT INTO question (topic_id, statement, stats, difficulty) VALUES
(1, 'Quanto � 1/2 + 1/4?',                   'NOT_VERIFIED', 'EASY'),
(1, 'Simplifique 6/9.',                       'NOT_VERIFIED', 'EASY'),
(1, 'Calcule 2/3 + 1/6.',                     'NOT_VERIFIED', 'EASY'),
(1, 'Simplifique a fra��o 15/25.',            'NOT_VERIFIED', 'EASY'),
(1, 'Quanto � 3/4 de 80?',                    'NOT_VERIFIED', 'MEDIUM'),
(1, 'Calcule 5/6 - 1/3.',                     'NOT_VERIFIED', 'EASY'),
(1, 'Qual fra��o � equivalente a 0,75?',      'NOT_VERIFIED', 'EASY'),
(1, 'Divida 3/4 por 1/2.',                    'NOT_VERIFIED', 'MEDIUM'),
(1, 'Calcule 2/5 � 5/8.',                     'NOT_VERIFIED', 'MEDIUM'),
(1, 'Qual � o resultado de 7/8 - 3/8?',       'NOT_VERIFIED', 'EASY');

-- EQUA��ES DE 1� GRAU (topic_id = 2)
INSERT INTO question (topic_id, statement, stats, difficulty) VALUES
...
(3, 'Qual � o discriminante de x� - 6x + 9 = 0?', 'NOT_VERIFIED', 'MEDIUM'),
(3, 'Resolva: 2x� - 8 = 0.',                  'NOT_VERIFIED', 'MEDIUM'),
(3, 'Resolva: x� + 5x + 6 = 0.',              'NOT_VERIFIED', 'MEDIUM'),
(3, 'Resolva: x� - 7x + 12 = 0.',             'NOT_VERIFIED', 'HARD'),
(3, 'Qual � a raiz de x� - 4x + 4 = 0?',      'NOT_VERIFIED', 'MEDIUM');

-- PORCENTAGEM (topic_id = 4)
INSERT INTO question (topic_id, statement, stats, difficulty) VALUES
(4, 'Quanto � 20% de 150?',                                                          'NOT_VERIFIED', 'EASY'),
(4, 'Um produto de R$80 teve 15% de desconto. Qual o novo pre�o?',                   'NOT_VERIFIED', 'EASY'),
(4, 'Um sal�rio de R$2000 teve aumento de 10%. Qual o novo valor?',                  'NOT_VERIFIED', 'EASY'),
(4, 'De 200 alunos, 25% foram aprovados. Quantos foram aprovados?',                  'NOT_VERIFIED', 'EASY'),
(4, 'Quanto � 35% de 200?',                                                          'NOT_VERIFIED', 'EASY'),
(4, 'Se 60 representa 30% de um total, qual � o total?',                             'NOT_VERIFIED', 'MEDIUM'),
(4, 'Calcule 150% de 60.',                                                           'NOT_VERIFIED', 'MEDIUM'),
(4, 'Um produto foi vendido por R$90 com 10% de desconto. Qual era o pre�o original?','NOT_VERIFIED', 'MEDIUM'),
(4, 'Quanto � 5% de 1000?',                                                          'NOT_VERIFIED', 'EASY');

-- REGRA DE TR�S (topic_id = 5)
INSERT INTO question (topic_id, statement, stats, difficulty) VALUES
(5, 'Se 3 kg custam R$12, quanto custam 5 kg?',                                                   'NOT_VERIFIED', 'EASY'),
(5, '4 oper�rios constroem em 30 dias. Em quantos dias 6 oper�rios fariam o mesmo?',              'NOT_VERIFIED', 'HARD'),
(5, 'Um carro percorre 120 km em 2h. Quanto percorre em 5h?',                                     'NOT_VERIFIED', 'EASY'),
(5, 'Escala 1:5000. Uma dist�ncia de 3 cm no mapa equivale a quantos metros?',                    'NOT_VERIFIED', 'MEDIUM'),
...
(5, '10 pe�as produzidas em 4h. Quantas pe�as em 10h?',                                           'NOT_VERIFIED', 'EASY'),
(5, 'Um trem percorre 180 km em 3h. Qual sua velocidade m�dia?',                                  'NOT_VERIFIED', 'MEDIUM');

-- GEOMETRIA PLANA (topic_id = 6)
INSERT INTO question (topic_id, statement, stats, difficulty) VALUES
(6, 'Qual � a �rea de um quadrado com lado 7 cm?',                                   'NOT_VERIFIED', 'EASY'),
(6, 'Calcule o per�metro de um ret�ngulo de 8 cm � 5 cm.',                           'NOT_VERIFIED', 'EASY'),
(6, '�rea de um tri�ngulo com base 10 cm e altura 6 cm?',                            'NOT_VERIFIED', 'EASY'),
(6, '�rea de um c�rculo com raio 5 cm. (? = 3,14)',                                  'NOT_VERIFIED', 'MEDIUM'),
(6, 'Per�metro de um tri�ngulo equil�tero com lado 9 cm?',                           'NOT_VERIFIED', 'EASY'),
(6, '�rea de um trap�zio com bases 6 e 10 e altura 4?',                              'NOT_VERIFIED', 'MEDIUM'),
(6, 'Circunfer�ncia de um c�rculo com di�metro 10. (? = 3,14)',                      'NOT_VERIFIED', 'MEDIUM'),
(6, 'A diagonal de um quadrado com lado 4 cm mede quanto? (?2 ? 1,41)',              'NOT_VERIFIED', 'HARD');

-- TRIGONOMETRIA (topic_id = 7)
INSERT INTO question (topic_id, statement, stats, difficulty) VALUES
(7, 'Em um tri�ngulo ret�ngulo, sen(30�) = ?',                                       'NOT_VERIFIED', 'EASY'),
(7, 'Cos(60�) = ?',                                                                  'NOT_VERIFIED', 'EASY'),
(7, 'Se a hipotenusa � 10 e um �ngulo � 30�, qual � o cateto oposto?',               'NOT_VERIFIED', 'MEDIUM'),
(7, 'Tg(45�) = ?',                                                                   'NOT_VERIFIED', 'EASY'),
(7, 'Qual � o valor de sen�(x) + cos�(x)?',                                          'NOT_VERIFIED', 'MEDIUM'),
(7, 'Em um tri�ngulo ret�ngulo com catetos 3 e 4, qual � a hipotenusa?',              'NOT_VERIFIED', 'MEDIUM'),
(7, 'Se sen(x) = 0,6 no 1� quadrante, qual � cos(x)?',                               'NOT_VERIFIED', 'HARD');

-- FUN��ES (topic_id = 8)
INSERT INTO question (topic_id, statement, stats, difficulty) VALUES
(8, 'f(x) = 2x + 3. Qual � f(4)?',                                                  'NOT_VERIFIED', 'EASY'),
(8, 'f(x) = x� - 1. Qual � f(3)?',                                                  'NOT_VERIFIED', 'EASY'),
(8, 'Qual � a raiz de f(x) = 3x - 9?',                                              'NOT_VERIFIED', 'EASY'),
(8, 'A fun��o f(x) = -x + 5 � crescente ou decrescente?',                            'NOT_VERIFIED', 'EASY'),
(8, 'Qual � o coeficiente angular de f(x) = 4x - 7?',                               'NOT_VERIFIED', 'MEDIUM'),
(8, 'Para f(x) = x� + 2x + 1, qual � o v�rtice?',                                   'NOT_VERIFIED', 'HARD'),
(8, 'Qual � o dom�nio de f(x) = 1/(x - 2)?',                                        'NOT_VERIFIED', 'HARD');

-- SISTEMAS DE EQUA��ES (topic_id = 9)
INSERT INTO question (topic_id, statement, stats, difficulty) VALUES
...
(9, 'Se x + y = 7 e xy = 12, quais s�o x e y?',                                     'NOT_VERIFIED', 'HARD'),
(9, 'Resolva: 4x - y = 6 e 2x + y = 9.',                                            'NOT_VERIFIED', 'MEDIUM'),
(9, 'Resolva: x/2 + y = 4 e x + y/2 = 5.',                                         'NOT_VERIFIED', 'HARD');

-- N�MEROS INTEIROS (topic_id = 10)
INSERT INTO question (topic_id, statement, stats, difficulty) VALUES
(10, 'Quanto � (-3) � (-4)?',                                                        'NOT_VERIFIED', 'EASY'),
(10, 'Calcule: (-8) + 5.',                                                           'NOT_VERIFIED', 'EASY'),
(10, 'Quanto � (-2)�?',                                                              'NOT_VERIFIED', 'MEDIUM'),
(10, 'Calcule: 15 - (-6).',                                                          'NOT_VERIFIED', 'EASY'),
(10, 'Qual � o valor absoluto de -17?',                                              'NOT_VERIFIED', 'EASY'),
(10, 'Quanto � (-5) � 3 + 2?',                                                       'NOT_VERIFIED', 'MEDIUM'),
(10, 'Resolva: (-4) � (-2) + 3.',                                                    'NOT_VERIFIED', 'MEDIUM');

-- POTENCIA��O (topic_id = 11)
INSERT INTO question (topic_id, statement, stats, difficulty) VALUES
(11, 'Quanto � 2??',                                                                 'NOT_VERIFIED', 'EASY'),
(11, 'Calcule 3� � 3�.',                                                             'NOT_VERIFIED', 'MEDIUM'),
(11, 'Quanto � (2�)�?',                                                              'NOT_VERIFIED', 'MEDIUM'),
(11, 'Calcule 5?.',                                                                  'NOT_VERIFIED', 'EASY'),
(11, 'Quanto � 2?�?',                                                                'NOT_VERIFIED', 'HARD'),
(11, 'Calcule (3�)�.',                                                               'NOT_VERIFIED', 'MEDIUM'),
(11, 'Quanto � 4� + 4�?',                                                            'NOT_VERIFIED', 'EASY');

-- RADICIA��O (topic_id = 12)
INSERT INTO question (topic_id, statement, stats, difficulty) VALUES
(12, 'Quanto � ?144?',                                                               'NOT_VERIFIED', 'EASY'),
(12, 'Calcule �?27.',                                                                'NOT_VERIFIED', 'MEDIUM'),
(12, 'Simplifique ?50.',                                                             'NOT_VERIFIED', 'MEDIUM'),
(12, 'Quanto � ?(9/16)?',                                                            'NOT_VERIFIED', 'MEDIUM'),
(12, 'Calcule ?81 + ?25.',                                                           'NOT_VERIFIED', 'EASY'),
(12, 'Quanto � ??16?',                                                               'NOT_VERIFIED', 'HARD'),
(12, 'Simplifique ?48.',                                                             'NOT_VERIFIED', 'HARD');

-- MMC E MDC (topic_id = 13)
INSERT INTO question (topic_id, statement, stats, difficulty) VALUES
(13, 'Qual � o MMC de 4 e 6?',                                                       'NOT_VERIFIED', 'EASY'),
(13, 'Qual � o MDC de 12 e 8?',                                                      'NOT_VERIFIED', 'EASY'),
(13, 'Qual � o MMC de 3, 4 e 6?',                                                    'NOT_VERIFIED', 'MEDIUM'),
(13, 'Qual � o MDC de 24 e 36?',                                                     'NOT_VERIFIED', 'MEDIUM'),
(13, 'Dois �nibus partem juntos, um a cada 15 min e outro a cada 20 min. Em quanto tempo partem juntos novamente?', 'NOT_VERIFIED', 'MEDIUM'),
(13, 'Qual � o MDC de 45 e 30?',                                                     'NOT_VERIFIED', 'MEDIUM'),
(13, 'Qual � o MMC de 5 e 7?',                                                       'NOT_VERIFIED', 'EASY'),
(13, 'Qual � o MDC de 100 e 75?',                                                    'NOT_VERIFIED', 'MEDIUM'),
(13, 'Qual � o MMC de 6 e 9?',                                                       'NOT_VERIFIED', 'EASY');
...
-- Q24 (?=0)
(24, '?=9',  false), (24, '?=3',  false), (24, '?=0',  true),
-- Q25 (2x�-8=0 ? x=�2)
