...
<head>
    ...
    <title>Kairos - Criar Tópico</title>
...
<main class="flex-1 p-4 md:p-9 overflow-y-auto flex flex-col items-start">
    ...
    <div class="w-full max-w-3xl mx-auto">
        <header class="mb-8">
            ...
            <h1 class="text-[24px] md:text-[26px] font-bold">Criar novo tópico</h1>
            <p class="text-texto-opaco text-[12px] md:text-[13px] mt-1">Defina a matéria e os pré-requisitos (se necessário)</p>
        </header>
