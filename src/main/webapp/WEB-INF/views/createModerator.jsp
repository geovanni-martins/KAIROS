...
<main class="flex-1 p-4 pt-16 md:p-9 md:pt-20 overflow-y-auto flex flex-col items-start">
    ...
    <div class="w-full max-w-3xl mx-auto">
        <header class="mb-8">
            ...
            <p class="text-muted text-[12px] md:text-[13px] mt-1">Preencha os dados do novo moderador e selecione sua matéria</p>
        </header>
        ...
        <form action="${pageContext.request.contextPath}/admin/createModerator" method="POST" class="space-y-5 md:space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="space-y-2">
                    <label class="block text-[11px] font-semibold tracking-widest uppercase text-muted">Matéria Responsável</label>
