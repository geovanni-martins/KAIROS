...
<main class="min-h-screen flex items-center justify-center px-4 py-8">
    <section class="w-full max-w-lg rounded-[28px] border border-white/10 bg-surface p-6 shadow-[0_25px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:p-8">
        <form action="${pageContext.request.contextPath}/login" method="post" class="space-y-6">
            ...
            <div class="space-y-2">
                <label for="password" class="block text-sm font-semibold tracking-[0.18em] text-muted">Senha</label>
        ...
        <div class="mt-6 border-t border-white/10 pt-5 text-center text-sm text-content">
            <span>Não possui conta? </span><a href="${pageContext.request.contextPath}/register" class="font-semibold text-brand hover:text-brand-dark">Criar conta</a>
            <br>
            <a href="${pageContext.request.contextPath}/new-password" class="font-semibold text-brand hover:text-brand-dark">Mudar senha</a>
        </div>
    </section>
</main>
